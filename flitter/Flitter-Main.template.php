...
function template_flitter_twitter()
{
	...
	echo '
	<li>
		<a href="https://twitter.com/share" class="twitter-share-button" data-count="horizontal"', !empty($modSettings['flitter_twitter_via']) ? ' data-via="' . $modSettings['flitter_twitter_via'] . '"' : '', empty($modSettings['flitter_twitter_related']) ? '' : ' data-related="' . $modSettings['flitter_twitter_related'] . (!empty($modSettings['flitter_twitter_related_desc']) ? ':' . $modSettings['flitter_twitter_related_desc'] : '') . '"', '>Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script>
	</li>';
}
