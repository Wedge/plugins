...
abstract class BaseFacebook
{
	 ...
	 * to retrieve user information and then extract the user ID.
	 *
	 * @return integer Returns the UID of the Facebook user, or 0 if the Facebook user could not be determined.
	 */
