...
function template_facebook_create_password()
{
	...
	echo '
		<div>
			...
			<form action="<URL>?action=facebook;area=register" method="post" accept-charset="UTF-8" name="registration" id="registration">
...
function template_facebook_profile()
{
	...
	{
		echo '
		<form action="<URL>?action=profile;area=facebook" id="creator" method="post">
