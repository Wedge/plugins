 ...
 * WedgeDesk
 *
 * This file contains all of the language strings (both main description and help text) for all permissions that WedgeDesk contains.
 *
 * @package wedgedesk
...
$txt['shd_admin_permissions_homedesc'] = 'This area allows you to configure the permissions for WedgeDesk - from here you can create roles for your users based on templates, and assign those roles to your membergroups.';
...
$txt['shd_could_not_create_role'] = 'There was an error creating the role, please contact WedgeDesk.com for further support.';
