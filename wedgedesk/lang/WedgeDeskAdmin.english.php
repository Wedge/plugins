 ...
 * WedgeDesk
 *
 * This file contains all of the language strings used in WedgeDesk's administration panel which is loaded throughout the admin area.
 *
 * @package wedgedesk
...
//! @name Items for general ACP integration
//@{
$txt['scheduled_task_shd_scheduled'] = 'WedgeDesk daily maintenance';
$txt['scheduled_task_desc_shd_scheduled'] = 'Maintenance tasks and internal processing to be run daily for WedgeDesk. It is strongly not advised to disable this task.';

$txt['lang_file_desc_WedgeDesk'] = 'Main helpdesk';
$txt['lang_file_desc_WedgeDeskAdmin'] = 'Helpdesk Administration';
$txt['lang_file_desc_WedgeDeskLogAction'] = 'Action Log Entries';
$txt['lang_file_desc_WedgeDeskNotifications'] = 'Email Notifications';
$txt['lang_file_desc_WedgeDeskPermissions'] = 'Permissions';
$txt['lang_file_desc_WedgeDeskProfile'] = 'Profile Area';
$txt['lang_file_desc_WedgeDeskWho'] = 'Who\'s Online';
//@}

//! @name Items for the administration menu structure
//@{
// Admin menu items, the ones that aren't in WedgeDesk.english.php anyway...
...
//@{
$txt['shd_admin_info_desc'] = 'This is the information center for the helpdesk, powered by WedgeDesk. Here you can get the latest news as well as version-specific support.';
...
$txt['shd_admin_options_standalone_desc'] = 'This area manages the standalone mode for the helpdesk, that effectively disables the forum part of a Wedge installation.';
...
//! @name WedgeDesk info center
//@{
$txt['shd_live_from'] = 'Live from WedgeDesk.com';
$txt['shd_no_connect'] = 'Could not retrieve news file from wedgedesk.com';
...
$txt['shd_admin_help_live'] = 'This box displays the latest news and updates from www.wedgedesk.com. Keep your eyes open for new releases and bug fixes. If a new version of this add-on is released, you will also see a notification at the top of the helpdesk administration page.';
$txt['shd_admin_help_modification'] = 'This box contains various information about your installation of WedgeDesk.';
$txt['shd_admin_help_credits'] = 'This box lists all of the people that made WedgeDesk possible, from the developers of the actual code, to the support team and the beta testers.';
$txt['shd_admin_help_update'] = 'If you can see this box, you are most likely using an outdated version of WedgeDesk. Follow the guidelines in the notification in order to upgrade to the new release.';
...
//@{
$txt['shd_credits'] = 'WedgeDesk Credits';
$txt['shd_current_team'] = 'WedgeDesk Team';
$txt['shd_original_team'] = 'Original SimpleDesk 2.0 Team';
$txt['shd_credits_pretext'] = 'WedgeDesk is a fork derived from the BSD-licensed code of SimpleDesk 2.0, although much code has been rewritten. All original SimpleDesk code is available from <a href="http://www.simpledesk.net/" target="_blank">www.simpledesk.net</a>.';
...
$txt['shd_credits_contributors'] = 'The support team, beta testers, translators, and anyone else we missed, who contributed to the substance of what SimpleDesk became.';
//@}
...
$txt['shd_disable_unread_note'] = 'Normally, WedgeDesk adds a list of topics to the unread posts/unread replies page but sometimes (e.g. certain mobile themes) this does not always work so well.';
...
//! @name General language strings for the action log (entries are contained in WedgeDeskLogAction.english.php)
//@{
...
$txt['shd_admin_custom_fields_icon_desc'] = 'An optional icon displayed next to the field name. To add your own icon(s), simply place an image file in the %1$s folder. For best results, this should be a 13x13px png image.';
...
$txt['shd_admin_maint_desc'] = 'This area allows you to perform some common maintenance tasks within WedgeDesk.';
