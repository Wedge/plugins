 ...
 * WedgeDesk
 *
 * Displays search criteria options, plus the results of searching.
 *
 * @package wedgedesk
...
function template_search()
{
	...
	if (!empty($settings['shd_new_search_index']))
		echo '
	<br class="clear"><div class="errorbox"><img src="', $context['plugins_url']['Arantor:WedgeDesk'], '/images/warning.png" class="shd_icon_minihead"> &nbsp;', shd_allowed_to('admin_helpdesk', 0) ? $txt['shd_search_warning_admin'] : $txt['shd_search_warning_nonadmin'], '</div>';
	...
	<div class="roundframe">
		<form action="<URL>?action=helpdesk;sa=search2" method="post">
			<div class="content">
				<br>
				<dl class="settings">
					<dt>
	...
	echo '
				...
				<hr>
				<br>
				<input type="submit" value="', $txt['shd_search'], '" onclick="return submitThisOnce(this);" accesskey="s" class="submit">
			</div>
		</form>
	</div>';
...
function template_search_no_results()
{
	...
	// Back to the helpdesk.
	echo '
		', template_button_strip(array($context['navigation']['back'], $context['navigation']['search']), 'left');
...
function template_search_criteria()
{
	...
	<div class="information">
		...
		{
			echo '
			<li>', $txt['shd_search_text'], ' ', westr::htmlspecialchars($context['search_terms']), ' (', $context['match_all'] ? $txt['shd_search_match_all'] : $txt['shd_search_match_any'], ')</li>';
...
function template_search_results()
{
	...
	<div class="search_results_posts">
		<div class="windowbg', $use_bg2 ? '2' : '', ' wrc core_posts">
