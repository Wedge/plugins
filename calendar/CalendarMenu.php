...
function calendarMenu(&$items)
{
	...
	add_css('#m_' . (SKIN_SHORTMENU ? 'home_' : '') . 'calendar { display: inline-block; width: 16px; height: 16px; padding: 0; margin: ' . (SKIN_SHORTMENU ? '-2px 5px 0 4px; vertical-align: middle' : '4px 4px 0 2px') . '; background: url(' . $context['plugins_url']['Wedge:Calendar'] . '/img/calendar.gif) 0 2px no-repeat; }');
}
