...
$txt['users_online_today_hidden'] = ' plus %s hidden'; // doesn't matter how many are hidden, the same applies in English: 1 hidden, 10 hidden etc. You may add an array as needed.
